...
interface GradientGeneratorClientProps {
    initialGradients: SavedGradient[];
}

export default function GradientGeneratorContent({ initialGradients }: GradientGeneratorClientProps) {
    ...
    const [allGradients, setAllGradients] = useState<SavedGradient[]>([
        ...PRESET_GRADIENTS,
        ...initialGradients
    ]);

    // Client-side fetch removed for Vercel Cost Optimization
