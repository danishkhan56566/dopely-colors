...
export const HomeGuide = () => (
    <section className="max-w-7xl mx-auto py-32 px-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-center">
            ...
            <div className="md:col-span-4 bg-gray-900 p-8 md:p-10 rounded-[2.5rem] text-white flex flex-col">
            ...
            <div className="md:col-span-8 bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
