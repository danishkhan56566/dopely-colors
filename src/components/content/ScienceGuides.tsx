...
export const ConverterGuide = () => (
    ...
    >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-20">
            <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Why so many formats?</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                    Different industries speak different color languages. <strong>Hex</strong> is for web, <strong>CMYK</strong> is for printers, and <strong>LAB/LCH</strong> are for scientists who need to model human perception accurately.
                </p>
            </div>
            <div className="bg-gray-50 p-8 rounded-3xl">
                <h4 className="font-bold text-gray-900 mb-4">Quick Reference</h4>
                <ul className="space-y-2 text-sm text-gray-600">
                    <li><strong>Hex:</strong> #FF5733 (Web Design)</li>
                    <li><strong>RGB:</strong> 255, 87, 51 (Digital Screens)</li>
                    <li><strong>CMYK:</strong> 0, 66, 80, 0 (Process Printing)</li>
                    <li><strong>HSL:</strong> 14, 100%, 60% (Human Intuitive)</li>
                </ul>
            </div>
        </div>
    </ToolGuide>
...
export const MixerGuide = () => (
    ...
    >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-20">
            <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Subtractive vs. Additive</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                    Mixing light (digital) is different from mixing paint (pigment). Red + Green light makes Yellow, but Red + Green paint makes Brown. This tool lets you switch between <strong>RGB Mixing</strong> and <strong>Pigment Simulation</strong> (Kubelka-Munk theory).
                </p>
            </div>
        </div>
    </ToolGuide>
...
export const WheelGuide = () => (
    ...
    >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-20">
            <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">The Rules of Harmony</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
...
export const TonerGuide = () => (
    ...
    >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-20">
            <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Expanding your Palette</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
...
export const DuotoneGuide = () => (
    ...
    >
        <div className="grid md:grid-cols-2 gap-12 items-start mb-20">
            <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Stylizing Imagery</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
